...
class BankActivityPage extends ConsumerStatefulWidget {
  const BankActivityPage(
      {super.key,
  ...
  final String title;
  @override
  _BankActivityPageState createState() => _BankActivityPageState();
}

class _BankActivityPageState extends ConsumerState<BankActivityPage>
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.read(bankNotifierProvider.notifier).state;
            ...
            child: Tooltip(
              ...
              child: TextBox(
                ...
                onChanged: (value) => setState(() {
                  ref.read(bankNotifierProvider.notifier).searchRessource(
  ...
  Widget customItem(List<Ressources>? data) {
    return data!.isEmpty
        ? const CustomEmptyPage(url: "assets/gifs/GIF 9.gif")
        : CustomGridview(
