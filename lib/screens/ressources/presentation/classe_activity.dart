...
class ClasseActivityPage extends ConsumerStatefulWidget {
  const ClasseActivityPage(
      {super.key,
  ...
  final String title;
  @override
  _ClasseActivityPageState createState() => _ClasseActivityPageState();
}

class _ClasseActivityPageState extends ConsumerState<ClasseActivityPage>
  ...
  Widget build(BuildContext context) {
    ...
    final state = ref.read(classeNotifierProvider.notifier).state;
            ...
            child: Tooltip(
              ...
              child: TextBox(
                ...
                onChanged: (value) => setState(() {
                  ref.read(classeNotifierProvider.notifier).searchRessource(
