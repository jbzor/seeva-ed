...
class _FavoritesState extends ConsumerState<Favorites>
    ...
    return ScaffoldPage(
        ...
        bottomBar: SizedBox(
          ...
          child: state.map(
            ...
            loadSuccess: (value) {
              final data = ref.watch(havorisProvider).getList;
  ...
  Widget customItem(List<Ressources>? data) {
    return data!.isEmpty
        ? Center(
            child: Lottie.asset(
              "assets/json/empty_registre.json", //placeholder
