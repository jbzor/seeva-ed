...
import 'package:example/screens/details/modele/web_view.dart';
import 'package:example/screens/details/sample_list.dart';

/// Package imports
import 'package:example/screens/details/widget/search_bar.dart';
...
Future<void> updateControlItems() async {
  if (!kIsWeb && (Platform.isWindows || Platform.isLinux || Platform.isMacOS)) {
    await windowManager.setMinimumSize(const Size(775, 230));
