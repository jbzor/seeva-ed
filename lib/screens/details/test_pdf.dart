...
import 'package:example/screens/details/helpers/helper.dart';
import 'package:example/screens/details/helpers/toolbar_widgets.dart';
import 'package:example/screens/details/modele/model.dart';
import 'package:example/screens/details/modele/sample_view.dart';
...
// import './helpers/web_helper.dart' as helper;
...
class _CustomToolbarPdfViewerState extends SampleViewState {
  ...
  void initState() {
    super.initState();
    _documentPath =
        'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf';
    _isDesktopWeb = true;
    if (_isDesktopWeb) {
  ...
  void _showChooseFileMenu(BuildContext context) {
    ...
    if (chooseFileRenderBox != null) {
      final Column child = Column(
        ...
        children: <Widget>[
          _chooseFileEntry('GIS Succinctly',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('HTTP Succinctly',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('JavaScript Succinctly',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('Rotated Document',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('Single Page Document',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('Encrypted Document',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
          _chooseFileEntry('Corrupted Document',
              'assets/pdf/cahiers-dactivites/1ère année-Les nombres jusqu_à 50.pdf'),
        ],
      );
                ...
                Positioned(
                  ...
                  child: SfPdfViewer.asset(
                    ...
                    canShowScrollHead:
                        ...
                        isDesktop ? true : _canShowScrollHead,
  ...
  ImageIcon _getAnnotationIcon(PdfAnnotationMode mode) {
    ...
    switch (mode) {
      ...
      case PdfAnnotationMode.stickyNote:
        iconPath = 'images/pdf_viewer/sticky_note.png';
        iconSize = 18;
    }
...
class _TextMarkupMenuItemState extends State<TextMarkupMenuItem> {
  ...
  void didChangeDependencies() {
    _useMaterial3 = false;
    _textColor = Colors.black.withOpacity(0.87);
    super.didChangeDependencies();
  }
